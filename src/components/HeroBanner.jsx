            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>sufiyanworkspace@gmail.com</div>
                    </div>
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Sufiyan Memon</span>
                    </div>
                    <div className="max-w-[510px]">
                    I'm a Full Stack Blockchain Developer dedicated to crafting innovative solutions at the intersection of technology and decentralized systems. Explore my work and join me on a journey of redefining possibilities in blockchain development.
                    </div>
                </motion.div>
                {/* INTRO END */}
